...
$replace = '/Users/lifenghan/Desktop/_stanford-ner-2018-10-16';
				...
				open (TEST,"<:encoding(utf8)","$replace/tag_de/tag_corpus.tc.de-split-10kaa.txt") || die "can not open file: $!";  
				open (RESULT,">:encoding(utf8)","$replace/NE_de_extract/NE_tag_corpus.tc.de-split-10kaa.txt") || die "$!"; ## store the result
